        ...
        for network_key in network_keys:
            ...
            for season_key in season_keys:
                if season_key in net_group:
                    ...
                    # if normalize:
                    #     # Normalize node features over the temporal dimension
                    #     num_features = time_step_features.shape[-1]
                    #
                    #     # Flatten the features for normalization
                    #     time_step_features_flat = time_step_features.reshape(-1, num_features)
                    #
                    #     # Normalize
                    #     time_step_features_flat = normalize_min_max(time_step_features_flat)
                    #
                    #     # Reshape back to original dimensions
                    #     time_step_features = time_step_features_flat.reshape(24, 33, 2)
